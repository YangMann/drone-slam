...
public class AttitudeChart {
     ...
     * Update the chart.
     *
     * @param pitch The tuple containing the current signal level.
     * @param roll  The tuple containing the current signal level.
     * @param yaw   The tuple containing the current signal level.
     */
